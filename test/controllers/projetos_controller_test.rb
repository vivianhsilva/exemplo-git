...
class ProjetosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post projetos_url, params: { projeto: { descricao: @projeto.descricao, nome: @projeto.nome } }
    end
  ...
  test "should update projeto" do
    patch projeto_url(@projeto), params: { projeto: { descricao: @projeto.descricao, nome: @projeto.nome } }
